...
def attack(char_name: str, char_class: str) -> str:
    """Calculate attack points depending on the class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Calculate defend points depending on the class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Calculate special attack points depending on the class."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Provide examples of interactions depending on the class."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Provide the choice of a playable class."""
    approve_choice = None
    char_class = None
